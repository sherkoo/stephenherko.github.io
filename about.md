...
<section class="about-page">
  <div class="about-page-img">
    <img src="../img/pic.jpg" alt="{{ site.title }}" />
  </div>
  <div class="about-page-meta">
    ...
    <a target="_blank" href="{{ site.github }}"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="32" height="32" viewBox="0 0 32 32">
